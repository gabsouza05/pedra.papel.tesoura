...
function Resolucao() {
    ...
    if (
        ...
        (test.value == "pedra" && (test1.value == "lagarto" || test1.value == "tesoura")) ||
        (test.value == "lagarto" && (test1.value == "spock" || test1.value == "papel")) ||
        (test.value == "spock" && (test1.value == "tesoura" || test1.value == "pedra"))
    ) {
